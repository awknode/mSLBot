...
alias NBA.get.scores {
  if (%NBA.get.scores.NBA.TEMP.nick) .notice %NBA.get.scores.NBA.TEMP.nick Socket gathering data for NBA script.
...
alias NBA.get.scores.NBA.scorealert {
  ...
  if ($hget(NBA.get.scores.NBA.alert,%NBA.get.scores.NBA.TEMP.nick)) NBA.get.scores.NBA.msg  %NBA.get.scores.NBA.TEMP.nick $+ $chr(44) You can only can track one NBA team at a time.
    ...
    NBA.get.scores.NBA.msg 12N0B04A  Now monitoring:12 $gettok($1-,5,187)   Score:12  $replace( $+ $gettok($1-,7,187),:,$chr(32) to $chr(32),null,0)
...
alias NBA.get.scores.NBA.End {
    ...
    while ($hget(NBA.get.scores.NBA.alert,0).item > %a) {
      ...
      if (%newdata) {
        if ($gettok(%newdata,1,187) == final) {
          ...
          var %rand $rand(1,15)
          .timerScoreAlert. $+ $gettok(%item,2,46) $+ . $+ $replace(%Teams,$chr(32),.) 1 %rand msg $gettok(%item,2,46)   12N0B04A   4Final: %teams 12Score:2 $replace( $+ $gettok(%newdata,5,187),:,$chr(32) to $chr(32),null,0) 
          .msg $gettok(%item,1,46) 12N0B04A  4Final: %teams 12Score:2 $replace( $+ $gettok(%newdata,5,187),:,$chr(32) to $chr(32),null,0) 
          ...
          if ($gettok(%newdata,6,187) != $gettok(%data,2,187)) {
            ...
            .timerScoreAlert. $+ $gettok(%item,2,46) $+ . $+ $replace(%Teams,$chr(32),.) 1 $rand(1,10) msg $gettok(%item,2,46)   4[!ScoreAlert] 12N0B04A  %teams  12 New Score:2 $replace( $+ $gettok(%newdata,6,187),:,$chr(32) to $chr(32),null,0)  14 Status:3 $gettok(%newdata,5,187) 
  ...
  if (%NBA.get.scores.NBA.TEMP.info == search) && (%NBA.get.scores.NBA.TEMP.search) {
    ...
    if (%team == Sun) || (%team == Sunday) || (%team == Mon) || (%team == Monday) || (%team == Tue) || (%team == Tuesday) || (%team == Wed) || (%team == Wednesday) || (%team == Thu) || (%team == Thursday) || (%team == Fri) || (%team == Friday) || (%team == Sat) || (%team == Saturday) || (%team == Today) || (%team == Tomorrow) || (%team == Yesterday) {
      ...
      while ($hfind(NBA.get.scores,* $+ %abbr $+ *,0,w).data > %a) {
        inc %a
        if (%a == 1) NBA.get.scores.NBA.msg 12N0B04A $gettok(%item,2,187) $+ :
    ...
    elseif ($gettok(%item,1,187) == upcoming) {
      ...
      NBA.get.scores.NBA.msg  12N0B04A   %team0 14Record:12 $iif($gettok($gettok(%item,$iif($gettok(%team,0,32) == 1,4,4-5),187),1,32) isin $strip(%team0),$gettok(%item,6,187),$gettok(%item,$iif(%consensus,8,7),187))
    ...
    elseif ($gettok(%item,1,187) == final) {
      ...
      NBA.get.scores.NBA.msg  12N0B04A   %team0 Last game:12 $gettok(%item,2,187)
    ...
    elseif ($gettok(%item,1,187) == current) {
      ...
      NBA.get.scores.NBA.msg  12N0B04A   %team0 14Currently playing: $replace($gettok(%item,4,187),at,14@)
  ...
  if (%NBA.get.scores.NBA.TEMP.info == all) || (%NBA.get.scores.NBA.TEMP.info == current) {
    ...
    set %item
    if (%items) {
      NBA.get.scores.NBA.msg 12N0B04A  Games 12currently playing:
      while (%a < $gettok(%items,0,44)) {
        inc %a
        ;if (%a == 1) NBA.get.scores.NBA.msg  12N0B04A
  ...
  if (%NBA.get.scores.NBA.TEMP.info == all) || (%NBA.get.scores.NBA.TEMP.info == upcoming) {
    ...
    while ($hget(NBA.get.scores,NBA. $+ %a)) {
      ...
      if (upcoming isin $gettok(%data,1,187)) {
        if (%last != $gettok(%data,2,187)) NBA.get.scores.NBA.msg 12N0B04A  $gettok(%data,2,187) $+ :
        inc %total
...
on *:sockread:NBA.get.scores: {
  ...
  if ($sockerr) {
    ...
    .timerNBA.get.scores.NBA.error 1 10 NBA.get.scores.NBA.msg     12N0B04A  Socket Error. Please try again later. :(
    .timerNBA.get.scores.NBA.close 1 15 NBA.get.scores.NBA.close
    halt
  }
  else {
