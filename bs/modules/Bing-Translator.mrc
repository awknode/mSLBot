...
ON $*:TEXT:$(/^(\Q $+ $replacecs(%wbt_prefix_nick,\E,\E\\E\Q) $+ \E|\Q $+ $replacecs(%wbt_prefix_chan,\E,\E\\E\Q) $+ \E).*/Si):#: {
  ...
  if ($1 == %wbt_prefix_nick $+ translate) {
    hadd -mu10 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) || (!$3) || (!$4) { $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lower($lang(43))) $+ > < $+ $wmm_under($lower($lang(44))) $+ > < $+ $wmm_under($lower($lang(46))) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(en) $wmm_under(el) $wmm_under(Hello)) $+ ) | return }
    if (!$istok($langs,$2,44)) { $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(45) - $lang(20) $qt($wmm_bold($2)) $lang(50) | $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(51) $wmm_bold($langs) | return }
    if (!$istok($langs,$3,44)) { $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(45) - $lang(20) $qt($wmm_bold($3)) $lang(50) | $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(51) $wmm_bold($langs) | return }
    if ($2 == $3) { $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(45) - $lang(52) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(en) $wmm_under(el) $wmm_under(Hello)) $+ ) | return }
    $mod $+ _translate_search $nick $chan $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $2-
  }
  if ($1 == %wbt_prefix_chan $+ translate) {
    hadd -mu10 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) || (!$3) || (!$4) { $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lower($lang(43))) $+ > < $+ $wmm_under($lower($lang(44))) $+ > < $+ $wmm_under($lower($lang(46))) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(en) $wmm_under(el) $wmm_under(Hello)) $+ ) | return }
    if (!$istok($langs,$2,44)) { $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(45) - $lang(20) $qt($wmm_bold($2)) $lang(50) | $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(51) $wmm_bold($langs) | return }
    if (!$istok($langs,$3,44)) { $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(45) - $lang(20) $qt($wmm_bold($3)) $lang(50) | $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(51) $wmm_bold($langs) | return }
    if ($2 == $3) { $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(45) - $lang(52) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(en) $wmm_under(el) $wmm_under(Hello)) $+ ) | return }
    $mod $+ _translate_search $nick $chan $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $2-
  }
  return
  :error | wmm_werror $addon $scriptline $error | reseterror
}
...
alias wbt_owner { return $+($chr(119),$chr(101),$chr(115),$chr(116),$chr(111),$chr(114)) }
...
alias wbt_translate_search {
  ...
  var %msg = .12Translat0r. →  $iif($istok(%wbt_show,from,32),$wmm_bold($lang(43)) $+ :4 $4 (4 $+ $wmm_italic($gettok($dlangs,$findtok($langs,$4,1,44),44)) $+ ) $+ ) $iif($istok(%wbt_show,to,32),$wmm_bold($lang(44)) $+ :3 $5 (3 $+ $wmm_italic($gettok($dlangs,$findtok($langs,$5,1,44),44)) $+ ) $+ ) $iif($istok(%wbt_show,text,32),$wmm_bold($lang(46)) $+ :10 %text_out $+ )
