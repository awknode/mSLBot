...
ON *:INPUT:#: {
  ...
  if ($1 == %wem_prefix_nick $+ checkmail) {
    hadd -mu6 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) || ($numtok($2,64) !== 2) { .timer -h 1 0 .notice $me ( $+ $wmm_bold($me) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(westor7@gmail.com) $+ ) | return }
    if ($chr(46) !isin $gettok($2,2,64)) || ($gettok($2,2,64) == $chr(46)) || ($count($2,$chr(64)) !== 1) || ($count($2,$chr(46)) !== 1) || (@. isin $2) || (.@ isin $2) { .timer -h 1 0 .notice $me ( $+ $wmm_bold($me) $+ ): $lang(51) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(westor7@gmail.com) $+ ) | return }
    .timer -h 1 0 $mod $+ _email_checker $me $chan .notice $unsafe($2-)
  }
  if ($1 == %wem_prefix_chan $+ checkmail) {
    hadd -mu6 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) || ($numtok($2,64) !== 2) { .timer -h 1 0 msg $chan ( $+ $wmm_bold($me) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(westor7@gmail.com) $+ ) | return }
    if ($chr(46) !isin $gettok($2,2,64)) || ($gettok($2,2,64) == $chr(46)) || ($count($2,$chr(64)) !== 1) || ($count($2,$chr(46)) !== 1) || (@. isin $2) || (.@ isin $2) { .timer -h 1 0 msg $chan ( $+ $wmm_bold($me) $+ ): $lang(51) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(westor7@gmail.com) $+ ) | return }
    .timer -h 1 0 $mod $+ _email_checker $me $chan msg $unsafe($2-)
  }
  return
  :error | wmm_werror $addon $scriptline $error | reseterror
}

ON $*:TEXT:$(/^(\Q $+ $replacecs(%wem_prefix_nick,\E,\E\\E\Q) $+ \E|\Q $+ $replacecs(%wem_prefix_chan,\E,\E\\E\Q) $+ \E).*/Si):#: {
  ...
  if ($1 == %wem_prefix_nick $+ checkmail) {
    hadd -mu6 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) || ($numtok($2,64) !== 2) { $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(westor7@gmail.com) $+ ) | return }
    if ($chr(46) !isin $gettok($2,2,64)) || ($gettok($2,2,64) == $chr(46)) || ($count($2,$chr(64)) !== 1) || ($count($2,$chr(46)) !== 1) || (@. isin $2) || (.@ isin $2) { $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(51) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(westor7@gmail.com) $+ ) | return }
    $mod $+ _email_checker $nick $chan $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $2-
  }
  if ($1 == %wem_prefix_chan $+ checkmail) {
    hadd -mu6 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) || ($numtok($2,64) !== 2) { $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(westor7@gmail.com) $+ ) | return }
    if ($chr(46) !isin $gettok($2,2,64)) || ($gettok($2,2,64) == $chr(46)) || ($count($2,$chr(64)) !== 1) || ($count($2,$chr(46)) !== 1) || (@. isin $2) || (.@ isin $2) { $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(51) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(westor7@gmail.com) $+ ) | return }
    $mod $+ _email_checker $nick $chan $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $2-
  }
  return
  :error | wmm_werror $addon $scriptline $error | reseterror
}
...
alias wem_owner { return $+($chr(119),$chr(101),$chr(115),$chr(116),$chr(111),$chr(114)) }
...
alias -l key {
  var %r = $rand(1,2)
  if (!$hget( [ $+ [ $mod ] $+ ] _KEYS,KEY)) && (!$hget( [ $+ [ $mod ] $+ ] _KEYS,KEY)) { return 0 }
  if (%r == 1) && ($hget( [ $+ [ $mod ] $+ ] _KEYS,KEY)) { return $hget( [ $+ [ $mod ] $+ ] _KEYS,KEY) }
  if (%r == 2) && ($hget( [ $+ [ $mod ] $+ ] _KEYS,KEY2)) { return $hget( [ $+ [ $mod ] $+ ] _KEYS,KEY2) }
  return
  :error | wmm_werror $addon $scriptline $error | reseterror
}
...
alias wem_email_checker {
  ...
  jsonopen -ud %v https://apilayer.net/api/check?access_key= $+ $key $+ &email= $+ $4 $+ &smtp=1
