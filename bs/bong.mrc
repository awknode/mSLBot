...
on *:TEXT:*:#:{
  ...
  if ($1 == !bongrips) {
    if (!$2) {
      ...
      if ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips)) && ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips)) {
        ...
        else { msg $chan According to my bongbase, I have taken9 $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) bong rips during this IRC session, and9 $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) total bong rips since this script was loaded. }
      }
      elseif ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips)) && ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) == $null || $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) == 0) {
        if ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) == 1) { msg $chan According to my bongbase, I have taken9 0 bong rips during this IRC session, and a total of9 $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) whole bong rip since this script was loaded. }
        else { msg $chan According to my bongbase, I have taken9 0 bong rips during this IRC session, and9 $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) total bong rips since this script was loaded. }
      }
      elseif ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips)) && ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) == $null || $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) == 0) {
        if ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) == 1) { msg $chan According to my bongbase, I have taken9 $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) bong rip during this IRC session, and a total of9 0 whole bong rips since this script was loaded. What a fag. }
        else { msg $chan According to my bongbase, I have taken9 $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) bong rips during this IRC session, and a total of9 0 whole bong rips since this script was loaded. What a fag. }
      }
      else { msg $chan According to my bongbase, I have taken9 0 bong rips during this IRC session, and a total of9 0 whole bong rips since this script was loaded. I'm gay. 
      }
    }
    elseif ($1 == !bongme) {
      if (!$2) {
  ...
  alias rips {
    if ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips)) && ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips)) {
      if ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) == 1) {
        if ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) == 1) { msg $active According to my bongbase, I have taken9 $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) bong rip during this IRC session, and a total of9 $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) whole bong rip since this script was loaded. }
        else { msg $active According to my bongbase, I have taken9 $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) bong rip during this IRC session, and9 $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) total bong rips since this script was loaded. }
      }
      else { msg $active According to my bongbase, I have taken9 $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) bong rips during this IRC session, and9 $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) total bong rips since this script was loaded. }
    }
    elseif ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips)) && ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) == $null || $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) == 0) {
      if ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) == 1) { msg $active According to my bongbase, I have taken9 0 bong rips during this IRC session, and a total of9 $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) whole bong rip since this script was loaded. }
      else { msg $active According to my bongbase, I have taken9 0 bong rips during this IRC session, and9 $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) total bong rips since this script was loaded. }
    }
    elseif ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips)) && ($readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) == $null || $readini($qt($scriptdirbongrips.ini), bongrips, totalbongrips) == 0) {
      if ($readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) == 1) { msg $active According to my bongbase, I have taken9 $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) bong rip during this IRC session, and a total of9 0 whole bong rips since this script was loaded. ...Wait wtf?! }
      else { msg $active According to my bongbase, I have taken9 $readini($qt($scriptdirbongrips.ini), bongrips, currentbongrips) bong rips during this IRC session, and a total of9 0 whole bong rips since this script was loaded. ...Wait wtf?! }
    }
    else { msg $active According to my bongbase, I have taken9 0 bong rips during this IRC session, and a total of9 0 whole bong rips since this script was loaded. ...Wow I suck. }
  }
