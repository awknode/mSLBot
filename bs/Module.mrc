...
ON $*:TEXT:$(/^(\Q $+ $replacecs(%wts_prefix_nick,\E,\E\\E\Q) $+ \E|\Q $+ $replacecs(%wts_prefix_chan,\E,\E\\E\Q) $+ \E).*/Si):#: {
  ...
  if ($1 == %wts_prefix_nick $+ twitter) {
    hadd -mu6 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) { $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $nick ( $+ $wmm_bold($nick) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(from: $+ $ [ $+ [ $mod ] $+ ] _owner)) $+ ) | return }
    $mod $+ _twitter_search $nick $chan $iif(% [ $+ [ $mod ] $+ ] _output,notice,.notice) $2-
  }
  if ($1 == %wts_prefix_chan $+ twitter) {
    hadd -mu6 $upper($mod) $+ _FLOOD %cn 1
    if (!$2) { $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $chan ( $+ $wmm_bold($nick) $+ ): $lang(37) - $lang(38) $wmm_bold($1 < $+ $wmm_under($lang(46)) $+ >) - ( $+ $lang(39) $wmm_bold($1 $wmm_under(from: $+ $ [ $+ [ $mod ] $+ ] _owner)) $+ ) | return }
    $mod $+ _twitter_search $nick $chan $iif(% [ $+ [ $mod ] $+ ] _output,msg,.msg) $2-
  }
  return
  :error | wmm_werror $addon $scriptline $error | reseterror
}
...
alias wts_owner { return $+($chr(119),$chr(101),$chr(115),$chr(116),$chr(111),$chr(114)) }
...
alias wts_twitter_search {
  ...
  jsonhttpheader %vv Authorization Basic $key
  ...
  while (%x < % [ $+ [ $mod ] $+ ] _max_results) {
    ...
    if ($istok(% [ $+ [ $mod ] $+ ] _show,post_link,32)) { 
      ...
      elseif (%post_id) && (!% [ $+ [ $mod ] $+ ] _show_empty) { var %post_url = $iif(% [ $+ [ $mod ] $+ ] _tiny,$wmm_tinycom(https://twitter.com/ $+ %uname $+ /status/ $+ %post_id),https://twitter.com/ $+ %uname $+ /status/ $+ %post_id) }
    ...
    if (% [ $+ [ $mod ] $+ ] _show_empty) { 
      var %msg = 0,11 $+ $gettok($addon,1,45) $+ -0,14 $+ $gettok($addon,2,45) $+ : $wmm_bel $iif(%post_text !== $null,$wmm_bold($lang(43)) $+ :6 %post_text $+ ) $iif(%post_language !== $null,$wmm_bold($lang(44)) $+ :2 %post_language $+ ) $iif(%post_retweets !== $null,$wmm_bold($iif(%post_retweets == 1,$lang(49),$lang(45))) $+ :10 $gettok($bytes(%post_retweets,bd),1,46) $+ ) $iif(%post_favorites !== $null,$wmm_bold($iif(%post_favorites == 1,$lang(51),$lang(50))) $+ :13 $gettok($bytes(%post_favorites,bd),1,46) $+ ) $iif(%post_crdate !== $null,$wmm_bold($lang(52)) $+ :7 %post_crdate $+ ) $iif(%post_url,$wmm_bold($lang(53)) $+ :12 $wmm_under(%post_url) $+ ) $iif(%user_name !== $null,$wmm_bold($lang(54)) $+ :5 %user_name $iif(%user_username,$chr(40) $+ $wmm_italic($v1) $+ $chr(41) $+ ) $+ ) $iif(%user_desc !== $null,$wmm_bold($lang(55)) $+ :14 %user_desc $+ ) $iif(%user_location !== $null,$wmm_bold($lang(73)) $+ :3 %user_location $+ ) $iif(%user_posts !== $null,$wmm_bold($iif(%user_posts == 1,$lang(75),$lang(74))) $+ :10 $gettok($bytes(%user_posts,bd),1,46) $+ ) $iif(%user_listed !== $null,$wmm_bold($lang(56)) $+ :11 $gettok($bytes(%user_listed,bd),1,46) $+ ) $iif(%user_favorites !== $null,$wmm_bold($iif(%user_favorites == 1,$lang(58),$lang(57))) $+ :9 $gettok($bytes(%user_favorites,bd),1,46) $+ ) $iif(%user_followers !== $null,$wmm_bold($iif(%user_followers == 1,$lang(60),$lang(59))) $+ :13 $gettok($bytes(%user_followers,bd),1,46) $+ ) $iif(%user_followings !== $null,$wmm_bold($iif(%user_followings == 1,$lang(72),$lang(61))) $+ :4 $gettok($bytes(%user_followings,bd),1,46) $+ ) $iif(%user_url !== $null,$wmm_bold($lang(76)) $+ :12 $wmm_under(%user_url) $+ )
      %output $iif(% [ $+ [ $mod ] $+ ] _strip,$strip(%msg),%msg)
    }
    elseif (!% [ $+ [ $mod ] $+ ] _show_empty) { 
      var %msg = 0,11 $+ $gettok($addon,1,45) $+ -0,14 $+ $gettok($addon,2,45) $+ : $wmm_bel $iif(%post_text,$wmm_bold($lang(43)) $+ :6 %post_text $+ ) $iif(%post_language,$wmm_bold($lang(44)) $+ :2 %post_language $+ ) $iif(%post_retweets,$wmm_bold($iif(%post_retweets == 1,$lang(49),$lang(45))) $+ :10 $gettok($bytes(%post_retweets,bd),1,46) $+ ) $iif(%post_favorites,$wmm_bold($iif(%post_favorites == 1,$lang(51),$lang(50))) $+ :13 $gettok($bytes(%post_favorites,bd),1,46) $+ ) $iif(%post_crdate,$wmm_bold($lang(52)) $+ :7 %post_crdate $+ ) $iif(%post_url,$wmm_bold($lang(53)) $+ :12 $wmm_under(%post_url) $+ ) $iif(%user_name,$wmm_bold($lang(54)) $+ :5 %user_name $iif(%user_username,$chr(40) $+ $wmm_italic($v1) $+ $chr(41) $+ ) $+ ) $iif(%user_desc,$wmm_bold($lang(55)) $+ :14 %user_desc $+ ) $iif(%user_location,$wmm_bold($lang(73)) $+ :3 %user_location $+ ) $iif(%user_posts,$wmm_bold($iif(%user_posts == 1,$lang(75),$lang(74))) $+ :10 $gettok($bytes(%user_posts,bd),1,46) $+ ) $iif(%user_listed,$wmm_bold($lang(56)) $+ :11 $gettok($bytes(%user_listed,bd),1,46) $+ ) $iif(%user_favorites,$wmm_bold($iif(%user_favorites == 1,$lang(58),$lang(57))) $+ :9 $gettok($bytes(%user_favorites,bd),1,46) $+ ) $iif(%user_followers,$wmm_bold($iif(%user_followers == 1,$lang(60),$lang(59))) $+ :13 $gettok($bytes(%user_followers,bd),1,46) $+ ) $iif(%user_followings,$wmm_bold($iif(%user_followings == 1,$lang(72),$lang(61))) $+ :4 $gettok($bytes(%user_followings,bd),1,46) $+ ) $iif(%user_url,$wmm_bold($lang(76)) $+ :12 $wmm_under(%user_url) $+ )
      %output $iif(% [ $+ [ $mod ] $+ ] _strip,$strip(%msg),%msg)
    }
